...
\begin{tikzpicture}[
  ...
  % PITCH tier
  \node (pit1) [below right =0.5cm and 2cm of reg1] {H};
  \node (pit2) [below right =0.5cm and 2cm of reg2] {L};
  ...
  \draw (reg1) to[out=-30,in=-150] (reg2)
        to[out=-30,in=-150] (reg3);

  \draw (pit1) to[out=-30,in=-150] (pit2)
        to[out=-30,in=-150] (pit3);
...
\begin{tikzpicture}[-,shorten >=1pt]
	...
	\node (w) at (-1,1) {w};
	\node (re) at (2,1.5) {\textbf{Register}};
	\node (s) at (-1,0) {S};
	\node (r) at (0,-1) {R};
